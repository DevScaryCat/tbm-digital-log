...
// 월 정밀 전사 상한 (2026-08-16 Chris 확정: 900→600분 — 원가 방어선).
// 근거: 순매출 4,165원(4,900 − 스토어 15%)에서 STT ~5.9원/분 + AI ~900원이면 손익분기
// ≈ 550분. 600분은 ① 한 타임(20분×22일=440분) 여유 통과 ② 두 타임 현실 사용
// (오전 15+오후 10분×22일=550분) 통과 ③ 꽉 채워도 적자 월 ~300원(무시 가능) 수준.
// 걸리는 건 "매일 오전·오후 20분 풀 사용"(880분) 극단뿐. 실측은 stt_usage로 계속 쌓인다 —
// 오픈 후 분포 보고 재조정.
const MONTHLY_SECONDS_CAP = 600 * 60;
