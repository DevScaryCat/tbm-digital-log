        ...
        <div className="min-h-screen bg-cur-canvas">
            <div className="max-w-2xl mx-auto bg-cur-card min-h-screen ">
                <div className="sticky top-0 z-10 bg-cur-card border-b p-4 flex items-center gap-3">
                    ...
                    <h1 className="text-lg font-bold text-cur-ink">서비스 이용약관</h1>
                </div>
                ...
                <div className="p-6 space-y-8 text-sm text-cur-body leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제1조 (목적)</h2>
                        <p>이 약관은 TBM 일지 서비스(이하 &quot;서비스&quot;)가 제공하는 모든 서비스의 이용조건 및 절차, 이용자와 서비스의 권리·의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
                    </section>

                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제2조 (정의)</h2>
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제3조 (약관의 효력 및 변경)</h2>
                        <ul className="list-disc pl-5 space-y-1">
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제4조 (서비스의 제공)</h2>
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제5조 (이용자의 의무)</h2>
                        <ul className="list-disc pl-5 space-y-1">
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제6조 (서비스의 책임)</h2>
                        <ul className="list-disc pl-5 space-y-1">
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제7조 (콘텐츠의 관리)</h2>
                        <ul className="list-disc pl-5 space-y-1">
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제8조 (서비스 이용의 제한 및 중지)</h2>
                        <ul className="list-disc pl-5 space-y-1">
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제9조 (면책사항)</h2>
                        <ul className="list-disc pl-5 space-y-1">
                    ...
                    <section>
                        <h2 className="text-base font-bold text-cur-ink mb-3">제10조 (분쟁 해결)</h2>
                        <ul className="list-disc pl-5 space-y-1">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            <li><strong>구독의 취소</strong>: 이용자는 언제든지 정기결제(구독)를 취소할 수 있으며, 취소 시 다음 결제일부터 요금이 청구되지 않습니다.</li>
                            <li><strong>이용 기간에 따른 환불(중도 해지)</strong>: 구독 기간 중 해지하는 경우, 이미 결제한 이용요금 중 이용하지 않은 잔여 기간에 대해 일할 계산하여 환불합니다. (예: 30일 구독 중 10일 이용 후 해지 시, 잔여 20일분을 환불) 환불은 고객센터 요청 시 결제하신 수단으로 환급됩니다.</li>
                            <li><strong>전액 환불</strong>: 결제일로부터 7일 이내이며 서비스 이용 이력이 전혀 없는 경우에는 고객센터로 요청 시 전액 환불이 가능합니다.</li>
                            <li><strong>회사 귀책</strong>: 회사의 귀책사유로 인해 서비스를 지속할 수 없는 경우, 남은 기간에 비례하여 환불해 드립니다.</li>
                        </ul>
                    </section>
