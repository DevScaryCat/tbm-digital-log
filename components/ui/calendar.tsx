...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-transparent group/calendar p-1.5 sm:p-3 [--cell-size:1.75rem] min-[360px]:[--cell-size:1.95rem] sm:[--cell-size:2rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
